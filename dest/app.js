...
const selectedArtistContainer = document.querySelector('.selected-artist-container');
const selectedArtistTab = document.querySelector('.artist-selection-wrapper');
...
const artistOneContainer = document.querySelector('.artist-one-container');
const artistTwoContainer = document.querySelector('.artist-two-container');
const artistThreeContainer = document.querySelector('.artist-three-container');
const artistOneBtn = document.querySelector('.artist-one-btn');
const artistTwoBtn = document.querySelector('.artist-two-btn');
const artistThreeBtn = document.querySelector('.artist-three-btn');
...
const fadersImgOne = document.querySelectorAll(".fade-in-img-one");
const fadersImgTwo = document.querySelectorAll(".fade-in-img-two");
const appearOptions = {
...
const randomArtistContainer = document.querySelector('.random-artist-container');
...
showRandomElement();
const randomHours = [{ id: 1 }, { id: 2 }, { id: 3 }, { id: 4 }, { id: 5 }, { id: 6 }, { id: 7 }, { id: 8 }, { id: 9 }, { id: 10 }, { id: 11 }, { id: 12 }, { id: 3 }, { id: 14 }, { id: 15 }, { id: 16 }, { id: 17 }, { id: 18 }, { id: 19 }, { id: 20 }, { id: 21 }, { id: 22 }, { id: 23 }];
const randomDays = [{ id: 1 }, { id: 2 }, { id: 3 }, { id: 4 }, { id: 5 }];
...
const scrollContainer = document.querySelector(".picture-wrapper");
...
const renderSlider = (sliders) => {
  ...
  <div class="absolute bottom-0 flex flex-col gap-04rem padd-block-2rem z-i-10">
    ...
    sliderSlide === null || sliderSlide === void 0 ? void 0 : sliderSlide.appendChild(sliderBackground);
    sliderBox === null || sliderBox === void 0 ? void 0 : sliderBox.appendChild(sliderSlide);
};
